import { CalendarDays, Home, LayoutDashboard, LogIn, Monitor, Settings, Smartphone, Stethoscope, UserRoundCog, UsersRound } from 'lucide-react'
...
const links = [
  ...
  { to: '/admin/patients', label: 'المرضى', icon: UserRoundCog },
